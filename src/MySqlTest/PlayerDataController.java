		...
		if(file.isDirectory()){
			...
			try {
		    	for(int i=0;i<allFiles.length;i++){   
					...
					stmt.setString(11, "Data/players/portrait/"+checkString(getDataOfOneLine(tempString.get(1)))+".png");
					stmt.setString(12, "Data/players/action/"+checkString(getDataOfOneLine(tempString.get(1)))+".png");
					stmt.addBatch();
		    	}
