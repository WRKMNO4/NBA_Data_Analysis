...
public class Config {
	...
	public static final String[] PLAYER_TOTAL_INFO = {"赛季", "参赛场数","先发场数","篮板数","助攻数","在场时间","进攻数","防守数",
		"抢断数","盖帽数","失误数","犯规数","得分"} ;
	public static final String[] PLAYER_RECENT_INFO = {"日期","对阵","位置","在场时间","投篮命中数","投篮出手数","三分命中数","三分出手数","罚球命中数", "罚球出手数","进攻篮板",
	...
	public static final String[] TEAM_RECENT_INFO = {"日期","对阵","投篮命中数","投篮出手数","三分命中数","三分出手数","罚球命中数","罚球出手数","进攻篮板数","防守篮板数","篮板数"
